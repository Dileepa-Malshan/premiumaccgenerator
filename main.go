...
func main() {
	...
	fmt.Printf("%s has been started...\nMade with ❤️ by @Dileepa_Malshan.\n", b.User.Username)
...
func randomFormat() string {
	formats := []string{
		...
		"chrissnop04@gmail.com:Cleuza84!",
		"catarina.r.lucas@gmail.com:Catgat16",
		"hillmannazwar@gmail.com:hillmannazwar01",
		"dylan.griffin.2021@gmail.com:B18vt9q81pkl8!",
		"dmaugusto@gmail.com:D@250574",
		"marion.csdn@gmail.com:olly83600!",
		"madelinelucas2313@gmail.com:iloveharley2313",
		"rolandovasquezmolina@gmail.com:LSVd2021$",
	}
...
func start(ctx *ext.Context) error {
	...
	MSG = "*Hi %v,\n" +
		"I am an Spotify Account Generator Bot\n" +
		"-------------------------------------------------\n" +
		"I can provide premium accounts of Spotify.com\n" +
		"--------------------------------------------------\n" +
		"Do /gen to generate an account\n" +
		"--------------------------------------------------\n" +
		"❤️This Bot By DFX GIVEAWAYS❤️\n*"
